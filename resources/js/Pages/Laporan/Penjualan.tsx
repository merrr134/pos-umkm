...
import { formatDateTime, ReportSummary, SalesReportRow } from './laporan';
...
export default function Penjualan({
    ...
    transactions: Paginated<SalesReportRow>;
    ...
    const params = useMemo(() => {
        ...
        return params;
    }, [search, kasir, method, status, dateFrom, dateTo]);
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
                <ReportTabs />
                <ExportButtons
                    routeName="laporan.penjualan.export"
                    params={params}
                />
            </div>
            ...
            <div className="mt-5 rounded-2xl border border-slate-200 bg-white shadow-sm">
                ...
                <div className="overflow-x-auto px-5 sm:px-6">
                    <table className="w-full min-w-[1050px] border-separate [border-spacing:0_10px] text-left">
                        <thead>
                            <tr className="text-sm text-slate-500">
                                ...
                                <th className="px-4 pt-3 font-medium">Kasir</th>
                        ...
                        <tbody>
                            {navigating && <SkeletonRows cols={9} />}
                            ...
                            {!navigating && transactions.data.map((row) => (
                                <tr key={row.id} className="group">
                                    ...
                                    <td
                                        className={
                                            cellClass + ' rounded-r-xl border-r'
                                        }
                                    >
                                        <span
                                            className={
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-4 sm:px-6">
                    <p className="text-sm text-slate-600">
                        {summary.count} transaksi · Total omzet (lunas):{' '}
